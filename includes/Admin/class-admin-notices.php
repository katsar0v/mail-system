...
class Admin_Notices {
	...
	private function render_database_repair_notice(): void {
		...
		<div class="notice notice-error">
			...
			<p>
				<?php esc_html_e( 'Some required database columns are missing. This may cause subscription confirmation links to fail. Click the button below to repair the database.', 'mail-system' ); ?>
			</p>
			<p>
				<a href="<?php echo esc_url( $upgrade_url ); ?>" class="button button-primary">
